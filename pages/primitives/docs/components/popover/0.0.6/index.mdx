...
import { PopoverHero } from '../../../../../../components/Hero/PopoverHero';
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          When <Code>true</Code>, focus will be trapped within the
          component bounds.
        </span>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          interact with them: Once to close the popover, and again to
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          default, it will use <Code>Popover.Trigger</Code>.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          <Code>Popover.Content</Code> edge.
        </span>
      ),
    },
  ]}
...
This example abstracts the `Popover.Arrow` part and set a default `sideOffset` configuration.
