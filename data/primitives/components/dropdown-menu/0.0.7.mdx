...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-trigger',
      description: (
        <span>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-content',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          close the dropdown menu, and again to activate the element.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          use <Code>DropdownMenu.Trigger</Code>.
        </span>
      ),
    },
    {
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-arrow',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-item',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-group',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-label',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-checkbox-item',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-radio-group',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-radio-item',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-item-indicator',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-dropdown-menu-separator',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
export default () => (
  <DropdownMenu.Root>
    ...
    <StyledContent>
      ...
      <StyledItem onSelect={() => console.log('workos')}>WorkOS</StyledItem>
