...
<Accordion>
  <AccordionItem value="1">
    <AccordionTrigger>
      What if the content needs to appear on hover?
    </AccordionTrigger>
    <AccordionContent>
      Use [Hover Card](hover-card) or [Tooltip](tooltip) instead. Popover is
      designed to show on click and via keyboard interactions only.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="2">
    ...
    <AccordionContent>
      You can use the Popover to build complex, interactive components. However,
      if all content items are alike, the [Dropdown Menu](dropdown-menu)
