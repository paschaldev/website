...
<Accordion>
  <AccordionItem value="1">
    ...
    <AccordionContent>
      Use [Popover](popover) instead, which is accessible on click. By
      comparison, Tooltip is displayed on mouse hover and keyboard focus.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="3">
    <AccordionTrigger>
      How is Tooltip different from Hover Card?
    </AccordionTrigger>
    <AccordionContent>
