...
<Highlights
  features={[
    ...
    'Can expand only one panel at a time.',
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-accordion-header',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: 'string | null',
      default: 'radix-accordion-button',
      description: (
        <span>
          A string to use as the component selector for CSS purposes. It will be
          added as a data attribute. Pass <Code>null</Code> to remove selector.
...
export default () => (
  <StyledAccordion defaultValue="item-2">
    <StyledItem value="item-1">
      <StyledHeader>
        <StyledButton>
          Item 1
  ...
  data={[
    {
      ...
      description: (
        <span>
          When focus is on an <Code>Accordion.Button</Code> of a collapsed
    ...
    },
    {
      ...
      description: (
        <span>
          When focus is on an <Code>Accordion.Button</Code>, moves focus to the
          first <Code>Accordion.Button</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          When focus is on an <Code>Accordion.Button</Code>, moves focus to the
          last <Code>Accordion.Button</Code>.
        </span>
      ),
    },
  ]}
