...
This will ensure accessibility and consistent keyboard control is maintained. Here's an example using Stitches and Next.js:

```jsx line=11-20,26,29
import { styled } from '@stitches/react';
...
See [this example](/primitives/docs/components/navigation-menu#with-router-links) for more information on usage with third party routing components.
