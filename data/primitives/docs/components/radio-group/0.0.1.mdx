...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          The controlled value of the radio item to check. Should be
    ...
    },
    {
      ...
      description: (
        <span>
          When <Code>true</Code>, indicates that the user must check a
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          When <Code>true</Code>, makes the radio item not mutable,
          meaning the user cannot check the checkbox.
        </span>
      ),
    },
  ]}
