...
This component inherits props from the [Radix Tabs](/primitives/docs/components/tabs) primitive and supports [common margin props](/themes/docs/theme/layout#margin-props).
