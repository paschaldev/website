...
This component inherits parts and props from the [Radix Alert Dialog](/primitives/docs/components/alert-dialog) primitive and is visually identical to [Dialog](/themes/docs/components/dialog), though with differing semantics and behavior.
