...
This component inherits props from the [Radix Separator](/primitives/docs/components/separator) primitive and supports [common margin props](/themes/docs/theme/layout#margin-props).

<ThemesPropsTable name="separator" />
