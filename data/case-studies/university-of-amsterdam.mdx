...
authorPosition: Engineering Lead at the University of Amsterdam
...
companyLogoVariant: University of Amsterdam (Wide)
companyLogoWidth: 90%
---
...
<HeroQuote>
  What we like the most about Radix is the fact that its developer experience is
  so fresh. It just provides a great set of primitive components that are easy
  to customise and easy to style to our own needs.
</HeroQuote>
