---
metaTitle: Basedash
metaDescription: With Radix, Basedash implements new components in minutes, so they can spend more engineering resources on the core product.
author: Max Musing
...
<HeroQuote>
  With Radix, we can now implement new components in minutes and ship them
  within a day. This lets us spend more engineering resources on our core
  product.
</HeroQuote>
