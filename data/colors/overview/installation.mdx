...
Install Radix Colors from your terminal via npm or yarn. Current version is `1.0.0`
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@radix-ui/colors@1.0.0/blue.css" />
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@radix-ui/colors@1.0.0/blue-dark.css" />
```
