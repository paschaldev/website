...
<Tabs defaultValue="1" css={{ my: '$5' }}>
  <TabsList>
    <TabsTrigger value="1">Stitches</TabsTrigger>
    <TabsTrigger value="2">Styled Components</TabsTrigger>
    <TabsTrigger value="3">CSS</TabsTrigger>
  </TabsList>
  <TabsContent value="1">
...
:root {
  --graySolid: var(--gray9);
  --grayPlaceholderText: var(--gray9);

  --accentBorderHover: var(--blue8);
  --accentFocusRing: var(--blue8);
}
`}/>
    </TabsContent>
</Tabs>
...
const darkTheme = {
  ...
  // Remap your colors for dark mode
  panel: slate.slate2,
  panelContrast: whiteA.whiteA11,
  shadow: 'black',
  overlay: blackA.blackA12,
}
...
@import 'https://cdn.jsdelivr.net/npm/@radix-ui/colors@latest/slateA.css';
@import 'https://cdn.jsdelivr.net/npm/@radix-ui/colors@latest/whiteA.css';
@import 'https://cdn.jsdelivr.net/npm/@radix-ui/colors@latest/blackA.css';
...
:root {
  ...
  --blurple1: (var--violet1);
  --blurple2: (var--violet2);

  --caribbeanSunset1: (var--crimson1);
  --caribbeanSunset2: (var--crimson2);
}
`}/>
    </TabsContent>
</Tabs>
